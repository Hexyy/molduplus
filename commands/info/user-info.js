...
.addField('• Sunucuya Katılım Tarihi' , moment.duration(create).format('Y [yıl], D [gün], H [saat], m [dakika],s [saniye]')+'önce')
.addField('• Discorda Katılım Tarihi' , moment.duration(joined).format('Y [yıl], D [gün], H [saat], m [dakika],s [saniye]')+'önce')
