...
if(!await sistem.fetch(`sohbet.
_${message.author.id}_${message.channel.id}`)) return message.channel.send(new Discord.MessageEmbed().setColor('RED').setTitle('Hata').setDescription(`<:moldup_hayir:783582180113907742> Sohbet zaten kapalı!`))
