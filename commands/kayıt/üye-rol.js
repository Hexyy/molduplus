...
message.channel.send(nn.setTitle(`Görev Tamamlandı!`).setColor("#22BF41").setDescription(`${tik} Kayıt sistemi üye rolünü ${role} rol olarak ayarladım.`).setColor(AloneDogru)).then(a => a.delete({timeout: 10000}));
